...
#função que escolhe o time e divisão, e retorna os dados em uma lista de dicionários
def escolhe_time(time:str):
    ...
    divisao = input(str('Em qual divisão está o time?')).upper()

    if divisao == 'A':
        serie = '325'
        id_time = teams_adress_A[time.lower()][-4:]
        #endpoints de cada temporada
        enpoint_17 = '13100'
        enpoint_18 = '16183'
        enpoint_19 = '22931'
        enpoint_20 = '27591'
